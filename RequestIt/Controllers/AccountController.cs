...
using RequestIt.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.KlantEndUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.KlantEndUser));
                    }
                    ...
                    if (model.IsBehandelaar)
                    {
                        await _userManager.AddToRoleAsync(user, SD.BehandelaarEndUser);
                    }

                    await _userManager.AddToRoleAsync(user, SD.KlantEndUser);
